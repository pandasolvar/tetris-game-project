...
bg = pygame.image.load('images/castle1.jpg').convert()
game_bg = pygame.image.load('images/background.jpg').convert()

main_font = pygame.font.Font('font/font.ttf', 65)
font = pygame.font.Font('font/font.ttf', 45)

title_tetris = main_font.render('SKY-TETRIS', True, pygame.Color('darkorange'))
